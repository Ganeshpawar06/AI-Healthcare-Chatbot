...
# ------------------ Load Data ------------------
training = pd.read_csv('D:\Medical\Data\The_GALE_ENCYCLOPEDIA_of_MEDICINE_SECOND.pdf')
testing = pd.read_csv('D:\Medical\Data\The_GALE_ENCYCLOPEDIA_of_MEDICINE_SECOND.pdf')
